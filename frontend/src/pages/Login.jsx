...
export default function Login() {
  ...
  const handleVoterIdChange = (e) => {
    ...
    if (voterIdTouched) setVoterIdError(validators.voterId(e.target.value));
  };
            ...
            <>
              ...
              {loading && (
                <p className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                  ...
                  Checking face &amp; sending OTP — this can take up to a minute
                  if the server was idle.
                </p>
              )}
            </>
          )}
            ...
            <form onSubmit={handleVerifyOtp} className="flex flex-col gap-4">
              ...
              <TextInput
                ...
                onChange={(e) => {
                  ...
                  if (otpTouched) setOtpError(validators.otp(e.target.value));
                }}
                onBlur={() => {
                  setOtpTouched(true);
